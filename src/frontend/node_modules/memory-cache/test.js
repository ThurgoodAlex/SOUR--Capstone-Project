...
describe('node-cache', function() {
  ...
  describe('import()', function() {
    ...
    it('should ***REMOVED***cords into an empty cache', function() {
      cache.put('key1', 'value1');
      cache.put('key2', 'value2', 1000);
      var exportedJson = cache.exportJson();
    ...
    it('should ***REMOVED***cords into an already-existing cache', function() {
      cache.put('key1', 'value1');
      cache.put('key2', 'value2', 1000);
      var exportedJson = cache.exportJson();
    ...
    it('should ***REMOVED***cords into an already-existing cache and skip duplicates', function() {
      cache.debug(true);
